...
const BookingItem = ({ booking, settings }: BookingItemProps) => {
  ...
  return (
    <Sheet open={isSheetOpen} onOpenChange={handleSheetOpenChange}>
      <SheetTrigger className="w-full min-w-[calc(100vw-80px)] rounded-xl border-white bg-[#3EABFD] lg:min-w-[450px] lg:max-w-[450px]">
        <Card className="w-full min-w-[calc(100vw-80px)] lg:min-w-[450px] lg:max-w-[450px]">
